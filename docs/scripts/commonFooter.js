(() => {
  const footerHtml = (termsPath) => `
    <a class="github-link" href="https://github.com/Manse-Murhana/Camu-Box" target="_blank" rel="noopener" aria-label="GitHub repository">
  ...
  targets.forEach((target) => {
    ...
    target.innerHTML = footerHtml(termsPath);
  });
})();
